  ...
  return (
    <button
      ...
      className={classNames(className, 'hover:shadow-inner px-4 py-2 text-sm rounded-3xl', {
        'bg-purple-700 text-white hover:bg-purple-700 hover:text-white': variant === 'primary',
        'bg-red-700 text-white hover:bg-red-700 hover:text-white': variant === 'secondary',
